...
### Extended ToolBar
See [ExtendedToolBar.kt](/app/src/main/java/com/bhuvaneshw/pdfviewer/ExtendedToolBar.kt)
...
```
> [!NOTE]
> For Download listener see implementation in [PdfViewerActivity.kt](/app/src/main/java/com/bhuvaneshw/pdfviewer/PdfViewerActivity.kt)
